...
- Module query rewrite nằm trong một hệ thống RAG truy xuất thông tin từ tài liệu.
...
1. Bổ sung chủ ngữ / tân ngữ / thành phần bị lược bỏ dựa trên lịch sử hội thoại.
1. Giải tham chiếu (chỉ thị từ như “cái đó”, “nó”, “chế độ đó”… về thực thể cụ thể).
1. Duy trì chủ đề khi người dùng hỏi nối tiếp ngắn gọn.
1. Khử nhiễu, sửa lỗi gõ, loại bỏ từ đệm, làm rõ nghĩa.
1. Giữ nguyên thuật ngữ kỹ thuật / từ viết tắt ở dạng gốc (không tự ý dịch) để tối ưu retrieval.
...
- Bổ sung thành phần bị lược (chủ ngữ / tân ngữ)
...
1. **Ngôn ngữ của câu hỏi, lịch sử hội thoại và kết quả rewrite kỳ vọng phải khớp với ngôn ngữ của tài liệu nguồn** (hoặc ngôn ngữ mà người dùng cuối sẽ dùng để hỏi). Phần mô tả mục đích và điểm kiểm thử có thể viết bằng ngôn ngữ làm việc của nhóm QA.
...
- Đầu ra là một câu
- Giữ ngôn ngữ gốc của câu hỏi, thuật ngữ kỹ thuật giữ nguyên dạng
...
- Kết quả rewrite kỳ vọng phải **tự nhiên, đúng ngữ pháp** ở ngôn ngữ tương ứng, và phản ánh đúng những gì một người dùng thực sự sẽ hỏi.
- Ưu tiên các tình huống **gần với cách người dùng thật sự tra cứu loại tài liệu này**.
